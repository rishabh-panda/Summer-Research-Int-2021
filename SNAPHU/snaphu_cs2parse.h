...
int cs2mcfparse(signed char **residue, int**rowcost, int** colcost,
                long nNrow, long nNcol, long *n_ad, long *m_ad, node **nodes_ad,
                arc **arcs_ad, long *node_min_ad, double *m_c_ad, int **cap_ad )
{
...
int    *cap;                   /* array of capacities (changed to int) */
...
cap      = (int*) CAlloc ( 2*m,   sizeof(int) ); /* changed to int */
